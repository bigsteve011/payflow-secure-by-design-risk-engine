# PROJECT 1 - Enterprise Security Risk Assessment & Secure-By-Design Requirements Engine (PayFlow Edition)
...
* ⚖️ **Governance workflow** (Security Exception Review Board simulation)
...
This project solves the problem by providing a repeatable, automated, and auditable security assessment workflow.
...
### ☁️ Cloud Security Requirements
* Enforce encryption at rest and in transit
* Use CSPM tools for continuous compliance
* Infrastructure-as-Code (IaC) must pass security scanning
...
| Threat | DREAD Score | ISO Likelihood | ISO Impact | Final Risk Rating |
| :--- | :---: | :---: | :---: | :--- |
  ...
  dast:
    ...
    steps:
      - name: Run OWASP ZAP Baseline Scan
        run: zap-baseline.py -t https://payflow.example.com
...
### ⚖️ Security Exception Review Board Simulation
...
* How I communicate effectively with stakeholders and Senior Management
